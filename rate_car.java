...
public class rate_car extends AppCompatActivity {
...
//                    case R.id.home:
//                        Intent intent1 = new Intent(rate_car.this, MainActivity.class);
...
//
//                    case R.id.trends:
//                        Intent intent2 = new Intent(rate_car.this, Trends.class);
//                        startActivity(intent2);
//                        break;
//                    case R.id.profile:
//                        Intent intent3 = new Intent(rate_car.this, Profile.class);
...
//        });
        ...
        f_home.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent1 = new Intent(rate_car.this, Home.class);
                        startActivity(intent1);
                    }
                });
        f_trend.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent1 = new Intent(rate_car.this, Trends.class);
                        startActivity(intent1);
                    }
                });
        f_profile.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent1 = new Intent(rate_car.this, Profile.class);
                        startActivity(intent1);
                    }
                });
    }
